...
program2.name("ui-audit").description("Audit UI, accessibility, and performance issues").version(version);
program2.command("audit").description("Run the UI audit workflow").action(() => {
  console.log(source_default.green("\u2714 UI Audit CLI"));
