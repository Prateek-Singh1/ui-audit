...
import { findNodesByKinds, getJsxChildren, nodeLocation } from '../react/jsx-helpers.js';
  ...
  constructor() {
    super(
      defineRuleMetadata({
        ...
        description: 'Flags fragments wrapping a single child or nested redundantly.',
