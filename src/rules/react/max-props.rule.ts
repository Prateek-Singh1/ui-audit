...
import { findNodesByKinds, getJsxAttributes, getJsxTagName, nodeLocation } from './jsx-helpers.js';
  ...
  constructor() {
    super(
      defineRuleMetadata({
        ...
        documentationUrl:
          'https://github.com/Prateek-Singh1/ui-audit/blob/main/docs/rules/react/max-props.md',
      }),
    );
  }

  protected run(context: RuleContext): RuleResult {
    const findings = findNodesByKinds(context.ast.root, ['JsxOpeningElement', 'JsxSelfClosingElement'])
