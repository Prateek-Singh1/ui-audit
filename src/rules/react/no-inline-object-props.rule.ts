  ...
  constructor() {
    super(
      defineRuleMetadata({
        ...
        description: 'Discourages inline object literals passed directly as JSX props.',
        category: RuleCategory.React,
        severity: RuleSeverity.Info,
        recommended: false,
        enabledByDefault: true,
        documentationUrl:
          'https://github.com/Prateek-Singh1/ui-audit/blob/main/docs/rules/react/no-inline-object-props.md',
      }),
    );
  }
